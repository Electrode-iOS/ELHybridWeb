...
[![Version](https://img.shields.io/badge/version-v4.0.5-blue.svg)](https://github.com/Electrode-iOS/ELHybridWeb/releases/latest)
...
```
github "Electrode-iOS/ELHybridWeb" ~> 4.0.5
```
